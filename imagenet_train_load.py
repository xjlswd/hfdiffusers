...
def main():
    ...
    unet = UNet2DClassConditionModel.from_pretrained(
        "results/imagenette_liteunet_fixsample/checkpoint-28000/unet"
    )
    ...
    if args.use_ema:
        ...
        #     transformer_layers_per_block=(1, 1, 1, 1),
        # )
        ema_unet = UNet2DClassConditionModel.from_pretrained(
            "results/imagenette_liteunet_fixsample/checkpoint-28000/unet_ema"
        )
        ema_unet = EMAModel(
            ema_unet.parameters(),
