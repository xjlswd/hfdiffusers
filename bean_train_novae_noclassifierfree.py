...
from diffusers import UNet2DClassConditionModel1
...
def main():
    ...
    unet = UNet2DClassConditionModel1(
        64,
        in_channels=3,
        out_channels=3,
    ...
    # unet.load_state_dict(torch.load("results/bean_64/unet.pt"))

    # Create EMA for the unet.
    if args.use_ema:
        ema_unet = copy.deepcopy(unet)
        # ema_unet.load_state_dict(torch.load("results/bean_64/unet.pt"))

        ema_unet = EMAModel(
            ema_unet.parameters(),
            model_cls=UNet2DClassConditionModel1,
    ...
    if version.parse(accelerate.__version__) >= version.parse("0.16.0"):
        ...
        def load_model_hook(models, input_dir):
            ...
            for i in range(len(models)):
                ...
                load_model = UNet2DClassConditionModel1.from_pretrained(
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                latents = batch["image"].to(weight_dtype)
