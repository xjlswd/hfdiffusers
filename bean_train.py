...
def main():
    ...
    unet.load_state_dict(torch.load("results/bean_1/unet.pt"))
    ...
    if args.use_ema:
        ...
        ema_unet.load_state_dict(torch.load("results/bean_1/unet.pt"))
    ...
    def transform_images(examples):
        ...
        return {"image": images, "labels": examples["labels"]}
